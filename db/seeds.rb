...
#
# # Grab NFL data
# nfl_team_player_url = 'https://api.mysportsfeeds.com/v1.2/pull/nfl/2018-playoff/cumulative_player_stats.json?playerstats=Att,Comp,Yds,TD'
#
...
#   nfl_teams_players = nfl_teams_players['cumulativeplayerstats']['playerstatsentry']
#
...
puts Team.count.to_s
puts Player.count.to_s

puts Coach.count.to_s